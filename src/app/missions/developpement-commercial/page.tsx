...
const page = () => {
    const donneesCard = [
        ...
        },
        {
            ...
            description: `
                Je m’occupe pour vous du rassemblement des différents éléments variables de paie. 
        ...
        },
        {
            ...
            description: `
                Juriste en droit social et manager opérationnel aguerri, j’allie mes connaissances juridiques et mon expérience professionnelle au service de votre entreprise.
        ...
        },
        {
            ...
            description: `
                J’interviens comme manager externalisé auprès de vos collaborateurs et de votre force de vente.
