...
import Background from "@/images/background/backgroundGestion.webp"
    ...
    const donneesCard = [
        {
            ...
            description: `Le recrutement est le premier axe RH stratégique.
...
Intervenant déjà auprès d'organismes de formation, je saurai vous proposer des formations sur mesure.`,
    ...
    return (
        ...
        <div className={styles.missionPage}>
            <Header />
            <h1 className={styles.missionPage__title}>Gestion RH</h1>
